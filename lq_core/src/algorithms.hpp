...
typedef struct lq_algorithm_skyline_node
{
	lq_uint16x2_t pos;
	lq_uint16_t   width;
} lq_algorithm_skyline_node_t;

typedef struct lq_algorithm_skyline
{
	std::vector<lq_algorithm_skyline_node_t> nodes;
	lq_uint16x2_t size;
	lq_uint16_t   padding;
} *lq_algorithm_skyline_t;
