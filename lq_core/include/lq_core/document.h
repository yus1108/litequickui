...
typedef struct lq_document_callbacks
{
	...
	void (*draw_text)(lq_uintptr_t hdc, const lq_byte_t* utf8_bytes_text, lq_uintptr_t font_handle, const lq_color_t* color, const lq_rect_t* quad, lq_uintptr_t user_data);
	...
	void (*set_caption)(const lq_byte_t* utf8_bytes_caption, lq_uintptr_t user_data);
