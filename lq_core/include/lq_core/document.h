...
typedef struct lq_core_doument *lq_core_doument_t;
...
typedef struct lq_core_doument_callbacks
{
...
} lq_core_doument_callbacks_t;

LQ_CORE_API lq_core_doument_t lq_core_doument_create(const lq_utf8_str_t html_data, const lq_core_doument_callbacks_t* callbacks, lq_uintptr_t user_data);
LQ_CORE_API void 	           lq_core_doument_destroy(lq_core_doument_t document);

LQ_CORE_API lq_uintptr_t lq_core_doument_get_user_data(const lq_core_doument_t document);

LQ_CORE_API lq_pixel_t lq_core_doument_calc_layout(lq_core_doument_t document, lq_pixel_t max_width, lq_wrapper_render_type render_type);
LQ_CORE_API void       lq_core_doument_draw(lq_core_doument_t document, lq_uintptr_t hdc, lq_pixel_t x, lq_pixel_t y, const lq_rect_t* clip);