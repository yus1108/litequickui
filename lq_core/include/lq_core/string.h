...
LQ_CORE_API lq_bool_t lq_utf8_str_is_empty(const lq_utf8_str_t str);
...
LQ_CORE_API lq_bool_t lq_utf8_str_equals(const lq_utf8_str_t a, const lq_utf8_str_t b);